...
/// prompted them (CPU/Memory/Disk/Thermal restate themselves; Calendar and
/// lists must not be collapsed).
@Suite struct PanelDedupTests {
    ...
    @Test func headerPillKeepsUnrelatedText() {
        ...
        // Thermal's pill is a word, not "Thermal …".
        #expect(PanelDedup.headerPillText(title: "Thermal", pillText: "Cool") == "Cool")
    ...
    @Test func metricSummaryRowsAreRedundant() {
        ...
        #expect(PanelDedup.titleIsRedundant(rowTitle: "Thermal", headerTitle: "Thermal", pillText: "Cool"))
    }
    ...
    @Test func subtitleKeptWhenItAddsInformation() {
        ...
        #expect(PanelDedup.novelSubtitle("running cool", pillText: "Cool") == "running cool")
        #expect(PanelDedup.novelSubtitle(nil, pillText: "Cool") == nil)
    }
}
